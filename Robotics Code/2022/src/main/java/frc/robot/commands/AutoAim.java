...
public class AutoAim extends CommandBase {
  ...
  public AutoAim(Shooter shooter, Limelight limelight) {
    m_shooter = shooter; 
  ...
  public void execute() {
    ...
    // horizontalAdjustment = m_shooter.getHorizontalAngle() - tx;
    // m_shooter.setHorizontalAngle(horizontalAdjustment);
    m_shooter.setError(tx);
