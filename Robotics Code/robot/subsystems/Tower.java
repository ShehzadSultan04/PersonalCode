...
public class Tower extends SubsystemBase {
  ...
  public Tower() {
    m_indexerTower = new WPI_VictorSPX(Constants.CANID.kTower);
    m_indexerTower.enableVoltageCompensation(true);
    m_indexerTower.configVoltageCompSaturation(11);
    m_indexerTower.setNeutralMode(NeutralMode.Brake);
    m_digEnt = new DigitalInput(Constants.DIO.kTowerIn);
    // m_digEx = new DigitalInput(Constants.DIO.kTowerOut);

    m_indexerTower.setInverted(false);
  ...
  public void towerIdle(){
    m_indexerTower.set(0.65);
  }

  public void towerIdleSlow(){
