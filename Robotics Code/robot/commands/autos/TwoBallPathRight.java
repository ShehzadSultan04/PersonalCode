...
public class TwoBallPathRight extends SequentialCommandGroup {
  /** Creates a new TwoBallPathRight. */
  public TwoBallPathRight(Intake intake, Chassis chassis, Tower tower, Shooter shooter, Limelight limelight) {
