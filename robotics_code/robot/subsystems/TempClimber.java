...
public class TempClimber extends SubsystemBase {
  ...
  public TempClimber() {
    ...
    m_Extender.config_kP(0, Constants.ClimberConstants.kP);
    m_Extender.config_kD(0,Constants.ClimberConstants.kD);

    // m_sExtender.config_kF(0, Constants.ClimberC.kF);
    m_sExtender.config_kP(0, Constants.ClimberConstants.kP);
    m_sExtender.config_kD(0,Constants.ClimberConstants.kD);
