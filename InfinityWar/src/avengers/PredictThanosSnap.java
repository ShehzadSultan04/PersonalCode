...
public class PredictThanosSnap {
    ...
    public static void main (String[] args) {
        ...
        for (int i = 0; i < numOfNodes; i++){
            for (int j = 0; j < i; j++){
                if (adjacencyMatrix[i][j] == 1 && StdRandom.uniform() <= 0.5){
        ...
        DFS newDFS = new DFS(adjacencyMatrix, numOfNodes);
        ...
        newDFS.checkIsolation(firstVertex); 
        StdOut.println(newDFS.connectedCheck());
